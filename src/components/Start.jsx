...
const Start = () => {
	return (
		<div className="mt-[60px] w-[85%] mx-auto flex lg:flex-row flex-col lg:justify-between items-center justify-center">
			<div className="flex flex-col gap-6 lg:m-0 m-10">
				<h1 className="text-[#101828] text-[2rem] font-bold">
