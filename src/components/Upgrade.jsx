...
const Upgrade = () => {
	return (
		<div className="bg-[#F9FAFB] relative bottom-16 h-fit w-[100%] flex lg:flex-row flex-col justify-between mx-auto p-[40px] ">
			...
			<div className="flex gap-2 lg:mr-16 flex-col justify-center items-center lg:mt-0 mt-20px">
