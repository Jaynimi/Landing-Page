...
const Choose = () => {
	return (
		<div className="flex lg:flex-row flex-col justify-between mx-auto w-[75%]">
			<div className="">
				...
				<div className="grid grid-cols-2 gap-[40px]">
					<div className="flex flex-col items-start gap-[6px]">
						...
						/>
						<h5 className="text-[#1D2939] text-[1rem] font-bold">
			...
			<div className="lg:mt-[70px] mt-[30px] flex items-center justify-center">
				<div>
					<img
						src={arrow}
						alt=""
						className="relative top-[48px] right-8 z-50"
					/>
