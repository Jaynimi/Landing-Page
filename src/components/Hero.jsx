...
const Hero = () => {
	return (
		<div className="flex w-[75%] mx-auto flex-col gap-[50px] hero">
				...
				<div className="flex flex-col gap-[30px] bg-[#EFF8FF] border border-[#B2DDFF] shadow-md h-fit rounded-lg p-4">
					<div className="grid gap-4 grid-cols-3 ">
						...
						<div className="bg-purple-300 rounded-md">
							<img src={img6} alt="" className="relative top-[4.5px]" />
						</div>
						<div className="bg-green-400 rounded-md">
							<img src={img7} alt="" />
						</div>
						<div className="bg-purple-200 rounded-md">
							<img src={img8} alt="" className="relative top-[4px]" />
						</div>
			...
			<p className="text-center text-[#475467] text-[16px] ">
				Join 1,500+ companies already video conferencing the ClearLink way
			</p>
			<div className="flex  justify-between">
				<img className="w-1/12" src={shopify} alt="" />
				<img className="w-1/12" src={coinbase} alt="" />
				<img className="w-1/12" src={dropbox} alt="" />
				<img className="w-1/12" src={intercom} alt="" />
				<img className="w-1/12" src={marvel} alt="" />
				<img className="w-1/12" src={automatic} alt="" />
			</div>
		</div>
	);
};
